  ...
  servicesList: [
    {
      ...
      description:
        "Express Entry, Family Sponsorship, Provincial Nominee Programs (PNP).",
    },
    {
    ...
    },
    {
      ...
      description:
        "Citizenship applications, renewals, and proof of citizenship.",
    },
    {
      title: "Employer Services",
      description:
        "Labour Market Impact Assessments (LMIA) and work permit support.",
    },
    {
      title: "Immigration Advice & Representation",
      description:
        "Professional guidance, eligibility assessments, and representation.",
    },
    {
      title: "Settlement Support",
      description:
        "Practical advice on living, studying and working in Canada.",
    },
  ],
  ...
  whyChooseUsPoints: [
    {
      ...
      description: "Personalized service with attention detail.",
    },
    {
      svg: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>`,
      title: "Up-to-date Knowledge",
      description:
        "Up-to-date knowledge of Canadian immigration policies and procedures.",
    },
    {
      svg: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>`,
      title: "Clear Guidance",
      description: "Clear, transparent guidance every step of the way.",
    },
    {
      svg: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>`,
...
const businessDataFr = {
  ...
  langToggle: "English",
  businessNameFooter: "Nom de l'entreprise",
  ...
  servicesList: [
    {
      ...
      description:
        "Entrée express, parrainage familial, programmes des candidats des provinces (PCP).",
    },
    {
      title: "Résidence temporaire",
      description: "Visas de visiteur, permis d'études, permis de travail",
    },
    {
      title: "Cas de réfugiés et humanitaires",
      description: "Demandes d'asile, demandes humanitaires et de compassion.",
    },
    {
      title: "Services aux citoyens",
      description:
        "Demandes de citoyenneté, renouvellements et preuves de citoyenneté.",
    },
    {
      title: "Services aux employeurs",
      description:
        "Évaluations d'impact sur le marché du travail (EIMT) et soutien aux permis de travail.",
    },
    {
      title: "Conseils et représentation en immigration",
      description:
        "Conseils professionnels, évaluations d'admissibilité et représentation.",
    },
    {
      title: "Soutien à l'établissement",
      description:
...
export { businessData, businessDataFr };
